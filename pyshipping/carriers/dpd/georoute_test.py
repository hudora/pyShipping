...
class RouterTest(unittest.TestCase):
    ...
    def test_known_routes_world(self):
        ...
        self.assertDicEq(route.routingdata(), {'d_depot': u'0532', 'serviceinfo': '', 'country': 'BE',
                                               'd_sort': u'A369', 'o_sort': '52', 'service_text': 'D'})
        ...
        self.assertDicEq(route.routingdata(), {'d_depot': '0521', 'serviceinfo': '', 'country': 'NL',
                                               'd_sort': u'D663', 'o_sort': '52', 'service_text': 'D'})
        ...
        self.assertDicEq(route.routingdata(), {'d_depot': '1380', 'serviceinfo': '', 'country': 'CZ',
                                               'd_sort': '021', 'o_sort': '10', 'service_text': 'D'})
    ...
    def test_difficult_service(self):
        ...
        self.assertDicEq(route.routingdata(), {'d_depot': u'0634', 'serviceinfo': u'', 'country': 'AT',
                                               'd_sort': u'11', 'o_sort': u'62', 'service_text': u'D'})
    ...
    def test_international(self):
        ...
        self.assertEqual(get_route('AR', '1426').routingdata(),
            {'d_depot': u'0920', 'serviceinfo': u'', 'country': u'AR', 'd_sort': u'MIA', 'o_sort': u'16',
            'service_text': u'D'})
        # AZ   | 1073 | Baku
        self.assertEqual(get_route('AZ', '1073').routingdata(),
            {'d_depot': u'0918', 'serviceinfo': u'', 'country': u'AZ', 'd_sort': u'CDG', 'o_sort': u'16',
            'service_text': u'D'})
        ...
        self.assertEqual(get_route('BG', '1766').routingdata(),
            {'d_depot': u'1670', 'serviceinfo': u'', 'country': u'BG', 'd_sort': u'5555', 'o_sort': u'62',
            'service_text': u'D'})
        ...
        self.assertEqual(get_route('CZ', '16300').routingdata(),
            {'d_depot': u'1391', 'serviceinfo': u'', 'country': u'CZ', 'd_sort': u'840', 'o_sort': u'10',
            'service_text': u'D'})
        # CZ   | 71000 | Ostrava
        ...
        self.assertEqual(get_route('DE', '04316').routingdata(),
            {'d_depot': u'0104', 'serviceinfo': u'', 'country': u'DE', 'd_sort': u'2MEN', 'o_sort': u'10',
            'service_text': u'D'})
        ...
        self.assertEqual(get_route('FR', '91044').routingdata(),
            {'d_depot': u'0408', 'serviceinfo': u'', 'country': u'FR', 'd_sort': u'M06', 'o_sort': u'50',
            'service_text': u'D'})
        ...
        self.assertEqual(get_route('LT', '3031').routingdata(),
            {'d_depot': u'0594', 'serviceinfo': u'', 'country': u'LT', 'd_sort': u'32', 'o_sort': u'13',
            'service_text': u'D'})
        # LV   | 1039     | Riga
        self.assertEqual(get_route('LV', '1039').routingdata(),
            {'d_depot': u'0575', 'serviceinfo': u'', 'country': u'LV', 'd_sort': u'R39', 'o_sort': u'13',
            'service_text': u'D'})
        # NL   | 2742     | KZ Waddinxveen
        self.assertEqual(get_route('NL', '2742').routingdata(),
            {'d_depot': u'0521', 'serviceinfo': u'', 'country': u'NL', 'd_sort': u'D663', 'o_sort': u'52',
            'service_text': u'D'})
        # NL   | 7443TC   | Nijverdal
        self.assertEqual(get_route('NL', '7443TC').routingdata(),
            {'d_depot': u'0512', 'serviceinfo': u'', 'country': u'NL', 'd_sort': u'B535', 'o_sort': u'52',
            'service_text': u'D'})
        # NL   | 9405 JB  | Assen
        ...
        self.assertEqual(get_route('PL', '80516').routingdata(),
            {'d_depot': u'1306', 'serviceinfo': u'', 'country': u'PL', 'd_sort': u'01', 'o_sort': u'13',
            'service_text': u'D'})
        # PL   | 22300    | Krasnystaw
        self.assertEqual(get_route('PL', '22300').routingdata(),
            {'d_depot': u'1300', 'serviceinfo': u'', 'country': u'PL', 'd_sort': u'01', 'o_sort': u'13',
            'service_text': u'D'})
        # SE   | 11358    | Stockholm
        ...
        self.assertEqual(get_route('SI', '1225').routingdata(),
            {'d_depot': u'1696', 'serviceinfo': u'', 'country': u'SI', 'd_sort': u'13', 'o_sort': u'62',
            'service_text': u'D'})
        # SK   | 82105    | Bratislava
        self.assertEqual(get_route('SK', '82105').routingdata(),
            {'d_depot': u'0650', 'serviceinfo': u'', 'country': u'SK', 'd_sort': u'13', 'o_sort': u'10',
            'service_text': u'D'})
