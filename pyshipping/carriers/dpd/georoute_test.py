...
class RouterTest(unittest.TestCase):
    ...
    def test_known_routes_world(self):
        ...
        self.assertDicEq(route.routingdata(), {'d_depot': '0624', 'serviceinfo': '', 'country': 'AT',
                                               'd_sort': '63', 'o_sort': '0062', 'service_text': 'D'})
        ...
        self.assertDicEq(route.routingdata(), {'d_depot': '0628', 'serviceinfo': '', 'country': 'AT',
                                               'd_sort': u'3270', 'o_sort': '0062', 'service_text': 'D'})
        route = self.router.route(Destination('AT', '4400', 'Steyr'))
        self.assertDicEq(route.routingdata(), {'d_depot': '0624', 'serviceinfo': '', 'country': 'AT',
                                               'd_sort': '70', 'o_sort': '0062', 'service_text': 'D'})
        route = self.router.route(Destination('AT', '1220', 'Wien'))
        self.assertDicEq(route.routingdata(), {'d_depot': '0622', 'serviceinfo': '', 'country': 'AT',
                                               'd_sort': '30', 'o_sort': '0062', 'service_text': 'D'})
        ...
        self.assertDicEq(route.routingdata(), {'d_depot': '0627', 'serviceinfo': '', 'country': 'AT',
                                               'd_sort': '01', 'o_sort': '0062', 'service_text': 'D'})
        ...
        self.assertDicEq(route.routingdata(), {'d_depot': u'0532', 'serviceinfo': '', 'country': u'BE',
                                               'd_sort': u'A341', 'o_sort': u'0052', 'service_text': u'D'})
        route = self.router.route(Destination('BE', '4890', 'Thimister'))
        self.assertDicEq(route.routingdata(), {'d_depot': '0532', 'serviceinfo': '', 'country': 'BE',
                                               'd_sort': u'B326', 'o_sort': '0052', 'service_text': 'D'})
        ...
        self.assertDicEq(route.routingdata(), {'d_depot': '0617', 'serviceinfo': '', 'country': 'CH',
                                               'd_sort': '', 'o_sort': '0078', 'service_text': 'D'})
        ...
        self.assertDicEq(route.routingdata(), {'d_depot': '1380', 'serviceinfo': '', 'country': 'CZ',
                                               'd_sort': '021', 'o_sort': '0010', 'service_text': 'D'})
        ...
        self.assertDicEq(route.routingdata(), {'d_depot': '0728', 'serviceinfo': '', 'country': 'ES',
                                               'd_sort': '01', 'o_sort': '0016', 'service_text': 'D'})
    ...
    def test_difficult_routingdepots(self):
        ...
        self.assertDicEq(route.routingdata(), {'d_depot': u'0623', 'serviceinfo': u'', 'country': 'AT',
                                               'd_sort': u'01', 'o_sort': u'0062', 'service_text': u'D'})
        ...
        self.assertDicEq(route.routingdata(), {'d_depot': u'0628', 'serviceinfo': u'', 'country': 'AT',
                                               'd_sort': u'1290', 'o_sort': u'0062', 'service_text': u'D'})
        ...
        self.assertDicEq(route.routingdata(), {'d_depot': u'0625', 'serviceinfo': u'', 'country': 'AT',
                                               'd_sort': u'1000', 'o_sort': u'0062', 'service_text': u'D'})
        ...
        self.assertDicEq(route.routingdata(), {'d_depot': u'0307', 'serviceinfo': u'', 'country': 'SE',
                                               'd_sort': u'01', 'o_sort': u'0020', 'service_text': u'D'})
        ...
        self.assertDicEq(route.routingdata(), {'d_depot': u'0621', 'serviceinfo': u'', 'country': 'AT',
                                               'd_sort': u'64', 'o_sort': u'0062', 'service_text': u'D'})
    ...
    def test_postcode_spaces(self):
        ...
        self.assertEqual(route.routingdata(), {'o_sort': '0042', 'serviceinfo': '', 'country': 'DE',
        ...
        self.assertDicEq(route.routingdata(), {'d_depot': '1550', 'serviceinfo': '', 'country': 'GB',
                                               'd_sort': '', 'o_sort': '0052', 'service_text': 'D'})
    ...
    def test_problematic_routes(self):
        ...
        self.assertEqual(route.routingdata(), {'d_depot': u'0617', 'serviceinfo': '', 'country': u'CH',
                                               'd_sort': u'', 'o_sort': u'0078', 'service_text': u'D'})
        route = self.router.route(Destination('LI', '8440', 'Steinfort'))
        self.assertEqual(route.routingdata(), {'d_depot': u'0617', 'serviceinfo': '', 'country': u'CH',
                                               'd_sort': u'', 'o_sort': u'0078', 'service_text': u'D'})
    ...
    def test_international(self):
        # AR   | 1426  | Buenos Aire
        self.assertEqual(get_route('AR', '1426').routingdata(),
            {'d_depot': u'0920', 'serviceinfo': u'', 'country': u'AR', 'd_sort': u'', 'o_sort': u'0016',
             'service_text': u'D'})
        # AZ   | 1073 | Baku
        self.assertEqual(get_route('AZ', '1073').routingdata(),
            {'d_depot': u'0918', 'serviceinfo': '', 'country': 'AZ', 'd_sort': u'CDG', 'o_sort': u'0016',
             'service_text': u'D'})
        # BE   | 3960 | Bree/Belgien
        self.assertEqual(get_route('BE', '3960').routingdata(),
            {'d_depot': u'0532', 'serviceinfo': u'', 'country': u'BE', 'd_sort': u'A353', 'o_sort': u'0052',
            'service_text': u'D'})
        # BG   | 1766 | Sofia
        self.assertEqual(get_route('BG', '1766').routingdata(),
            {'d_depot': u'1670', 'serviceinfo': u'', 'country': u'BG', 'd_sort': u'5555', 'o_sort': u'0062',
            'service_text': u'D'})
        # CH   | 3601 | Thun/Schweiz
        self.assertEqual(get_route('CH', '3601').routingdata(),
            {'d_depot': u'0612', 'serviceinfo': u'', 'country': u'CH', 'd_sort': u'', 'o_sort': u'0078',
            'service_text': u'D'})
        # CZ   | 16300 | Praha 6- Repy
        self.assertEqual(get_route('CZ', '16300').routingdata(),
            {'d_depot': u'1391', 'serviceinfo': u'', 'country': u'CZ', 'd_sort': u'840', 'o_sort': u'0010',
            'service_text': u'D'})
        # CZ   | 71000 | Ostrava
        self.assertEqual(get_route('CZ', '71000').routingdata(),
            {'d_depot': u'1384', 'serviceinfo': u'', 'country': u'CZ', 'd_sort': u'412', 'o_sort': u'0010',
            'service_text': u'D'})
        # DE   | 04316 | Leipzig
        self.assertEqual(get_route('DE', '04316').routingdata(),
            {'d_depot': u'0104', 'serviceinfo': '', 'country': u'DE', 'd_sort': u'1MEN', 'o_sort': u'0010',
             'service_text': u'D'})
        # DE   | 99974 | M<C3><BC>hlhausen / Th<C3><BC>ringen
        self.assertEqual(get_route('DE', '99974').routingdata(),
            {'d_depot': u'0234', 'serviceinfo': u'', 'country': u'DE', 'd_sort': u'C015', 'o_sort': u'KK 2',
            'service_text': u'D'})
        # DK   | 4000  | Roskilde
        self.assertEqual(get_route('DK', '4000').routingdata(),
            {'d_depot': u'0500', 'serviceinfo': u'', 'country': u'DK', 'd_sort': u'01', 'o_sort': u'0020',
            'service_text': u'D'})
        # DK   | 9500   | Hobro
        self.assertEqual(get_route('DK', '9500').routingdata(),
            {'d_depot': u'0504', 'serviceinfo': u'', 'country': u'DK', 'd_sort': u'405', 'o_sort': u'0020',
            'service_text': u'D'})
        # EE   | 10621  | Tallinn
        self.assertEqual(get_route('EE', '10621').routingdata(),
            {'d_depot': u'0560', 'serviceinfo': u'', 'country': u'EE', 'd_sort': u'0005', 'o_sort': u'0013',
            'service_text': u'D'})
        # ES   | 08227  | Terrassa
        self.assertEqual(get_route('ES', '08227').routingdata(),
            {'d_depot': u'0708', 'serviceinfo': u'', 'country': u'ES', 'd_sort': u'01', 'o_sort': u'0016',
            'service_text': u'D'})
        # FI   | 94700  | Kemi
        self.assertEqual(get_route('FI', '94700').routingdata(),
            {'d_depot': u'1614', 'serviceinfo': u'', 'country': u'FI', 'd_sort': u'505', 'o_sort': u'0015',
            'service_text': u'D'})
        # FR   | 91044  | EVRY-LISSES
        self.assertEqual(get_route('FR', '91044').routingdata(),
            {'d_depot': u'0408', 'serviceinfo': '', 'country': u'FR', 'd_sort': u'S61', 'o_sort': u'0050',
             'service_text': u'D'})
        # GB   | BT387AR              | Carrickfergus
        self.assertEqual(get_route('GB', 'BT387AR').routingdata(),
            {'d_depot': u'1598', 'serviceinfo': u'', 'country': u'GB', 'd_sort': u'', 'o_sort': u'0052',
            'service_text': u'D'})
        # GB   | CB13SW               | Cambridge
        self.assertEqual(get_route('GB', 'CB13SW').routingdata(),
            {'d_depot': u'1550', 'serviceinfo': u'', 'country': u'GB', 'd_sort': u'', 'o_sort': u'0052',
            'service_text': u'D'})
        # GB   | G43 2DX              | Glasgow
        self.assertEqual(get_route('GB', 'G43 2DX').routingdata(),
            {'d_depot': u'1550', 'serviceinfo': u'', 'country': u'GB', 'd_sort': u'', 'o_sort': u'0052',
            'service_text': u'D'})
        # GB   | G432DX               | Glasgow
        self.assertEqual(get_route('GB', 'G432DX').routingdata(),
            {'d_depot': u'1550', 'serviceinfo': u'', 'country': u'GB', 'd_sort': u'', 'o_sort': u'0052',
            'service_text': u'D'})
        # GB   | N41NR                | London
        self.assertEqual(get_route('GB', 'N41NR').routingdata(),
            {'d_depot': u'1550', 'serviceinfo': u'', 'country': u'GB', 'd_sort': u'', 'o_sort': u'0052',
            'service_text': u'D'})
        # GR   | 17341  | Athens
        self.assertEqual(get_route('GR', '17341').routingdata(),
            {'d_depot': u'1900', 'serviceinfo': u'', 'country': u'GR', 'd_sort': u'', 'o_sort': u'0062',
            'service_text': u'D'})
        # GR   | 64200  | Chrisoupoli-KAVALA
        self.assertEqual(get_route('GR', '64200').routingdata(),
            {'d_depot': u'1948', 'serviceinfo': u'', 'country': u'GR', 'd_sort': u'', 'o_sort': u'0062',
            'service_text': u'D'})
        # HR   | 10000 | Zagreb
        self.assertEqual(get_route('HR', '10000').routingdata(),
            {'d_depot': u'1750', 'serviceinfo': u'', 'country': u'HR', 'd_sort': u'SVI', 'o_sort': u'0062',
            'service_text': u'D'})
        # HR   | 44000 | Sisak
        self.assertEqual(get_route('HR', '44000').routingdata(),
            {'d_depot': u'1750', 'serviceinfo': u'', 'country': u'HR', 'd_sort': u'020', 'o_sort': u'0062',
            'service_text': u'D'})
        # HU   | 1121  | Budapest
        self.assertEqual(get_route('HU', '1121').routingdata(),
            {'d_depot': u'1640', 'serviceinfo': u'', 'country': u'HU', 'd_sort': u'027', 'o_sort': u'0062',
            'service_text': u'D'})
        # HU   | 9400  | Sopron
        self.assertEqual(get_route('HU', '9400').routingdata(),
            {'d_depot': u'1646', 'serviceinfo': u'', 'country': u'HU', 'd_sort': u'663', 'o_sort': u'0062',
            'service_text': u'D'})
        # IT   | 34100    | Trieste / Italien
        self.assertEqual(get_route('IT', '34100').routingdata(),
            {'d_depot': u'0835', 'serviceinfo': u'', 'country': u'IT', 'd_sort': u'01', 'o_sort': u'0016',
            'service_text': u'D'})
        # LI   | 09494    | Schaan
        self.assertEqual(get_route('LI', '09494').routingdata(),
            {'d_depot': u'0617', 'serviceinfo': u'', 'country': u'CH', 'd_sort': u'', 'o_sort': u'0078',
            'service_text': u'D'})
        # LI   | 9999     | Wemperhardt
        self.assertEqual(get_route('LI', '9999').routingdata(),
            {'d_depot': u'0617', 'serviceinfo': u'', 'country': u'CH', 'd_sort': u'', 'o_sort': u'0078',
            'service_text': u'D'})
        # LI   | CH-9491  | Ruggell
        self.assertEqual(get_route('LI', 'CH-9491').routingdata(),
            {'d_depot': u'0617', 'serviceinfo': u'', 'country': u'CH', 'd_sort': u'', 'o_sort': u'0078',
            'service_text': u'D'})
        # LI   | 9491  | Ruggell
        self.assertEqual(get_route('LI', '9491').routingdata(),
            {'d_depot': u'0617', 'serviceinfo': u'', 'country': u'CH', 'd_sort': u'', 'o_sort': u'0078',
            'service_text': u'D'})
        # LT   | 3031     | Kaunas
        self.assertEqual(get_route('LT', '3031').routingdata(),
            {'d_depot': u'0594', 'serviceinfo': '', 'country': u'LT', 'd_sort': u'732', 'o_sort': u'0013',
             'service_text': u'D'})
        # LV   | 1039     | Riga
        self.assertEqual(get_route('LV', '1039').routingdata(),
            {'d_depot': u'0575', 'serviceinfo': u'', 'country': u'LV', 'd_sort': u'R39', 'o_sort': u'0013',
            'service_text': u'D'})
        # NL   | 7443TC   | Nijverdal
        self.assertEqual(get_route('NL', '7443TC').routingdata(),
            {'d_depot': u'0512', 'serviceinfo': '', 'country': u'NL', 'd_sort': u'A535', 'o_sort': u'0052',
             'service_text': u'D'})
        # NL   | 9405 JB  | Assen
        self.assertEqual(get_route('NL', '9405 JB').routingdata(),
            {'d_depot': u'0513', 'serviceinfo': u'', 'country': u'NL', 'd_sort': u'T421', 'o_sort': u'0052',
            'service_text': u'D'})
        # NO   | 6800     | Förde
        self.assertEqual(get_route('NO', '6800').routingdata(),
            {'d_depot': u'0360', 'serviceinfo': u'', 'country': u'NO', 'd_sort': u'01', 'o_sort': u'0015',
            'service_text': u'D'})
        # PL   | 80516    | Gdansk
        self.assertEqual(get_route('PL', '80516').routingdata(),
            {'d_depot': u'1306', 'serviceinfo': u'', 'country': u'PL', 'd_sort': u'01', 'o_sort': u'0013',
            'service_text': u'D'})
        # PL   | 22300    | Krasnystaw
        self.assertEqual(get_route('PL', '22300').routingdata(),
            {'d_depot': u'1300', 'serviceinfo': u'', 'country': u'PL', 'd_sort': u'01', 'o_sort': u'0013',
            'service_text': u'D'})
        # SE   | 11358    | Stockholm
        self.assertEqual(get_route('SE', '11358').routingdata(),
            {'d_depot': u'0312', 'serviceinfo': u'', 'country': u'SE', 'd_sort': u'01', 'o_sort': u'0020',
            'service_text': u'D'})
        # SE   | 75752    | Uppsala
        self.assertEqual(get_route('SE', '75752').routingdata(),
            {'d_depot': u'0312', 'serviceinfo': u'', 'country': u'SE', 'd_sort': u'01', 'o_sort': u'0020',
            'service_text': u'D'})
        # SI   | 1225     | Lukovica
        self.assertEqual(get_route('SI', '1225').routingdata(),
            {'d_depot': u'1696', 'serviceinfo': '', 'country': u'SI', 'd_sort': u'14', 'o_sort': u'0062',
             'service_text': u'D'})
        # SK   | 82105    | Bratislava
...
class HighLevelTest(unittest.TestCase):
    ...
    def test_get_route(self):
        self.assertEqual(vars(get_route('DE', '42897')),
            {'service_mark': u'', 'o_sort': u'0042', 'serviceinfo': u'', 'barcode_id': u'37',
        ...
        self.assertEqual(vars(get_route('LI', '8440')),
            {'service_mark': u'', 'o_sort': u'0078', 'serviceinfo': u'', 'barcode_id': u'37',
